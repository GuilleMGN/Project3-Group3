...
1. Simple images were generated and constructed to be layered as per two screenshots (1A and 1B) below. 
2. Updated configure.js file in input folder to reflect the new layers (2)
